...
const CLIENT_BUILD = 114 // номер актуальной клиентской сборки (index.html) для авто-обновления
...
server.listen(PORT, () => {
  console.log('SVchat server (v114: sync ver=CLIENT_BUILD, remove dead /contacts endpoint) на порту ' + PORT)
})
