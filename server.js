...
const CLIENT_BUILD = 140 // номер актуальной клиентской сборки (index.html) для авто-обновления
...
server.listen(PORT, () => {
  console.log('SVchat server (v140: анти-засыпание + таймаут регистрации 20с) на порту ' + PORT)
})
