...
const CLIENT_BUILD = 139 // номер актуальной клиентской сборки (index.html) для авто-обновления
...
server.listen(PORT, () => {
  console.log('SVchat server (v139: Socket.IO polling-only для прохода через Cloudflare в РФ) на порту ' + PORT)
})
