...
const CLIENT_BUILD = 144 // номер актуальной клиентской сборки (index.html) для авто-обновления
...
server.listen(PORT, () => {
  console.log('SVchat server (v143: сокет подключается заранее (вход с первого раза) + фикс auth' + PORT)
})
