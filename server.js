...
const CLIENT_BUILD = 138 // номер актуальной клиентской сборки (index.html) для авто-обновления
...
server.listen(PORT, () => {
  console.log('SVchat server (v138: sync ver=CLIENT_BUILD, remove dead /contacts endpoint) на порту ' + PORT)
})
